 ...
 * Reference URL: https://makecode.microbit.org/blocks-embed
 * @param targetUrl  full editor url (including trailing /)
 * @param renderBlocksPackage options.package of renderblocks (string or array of string)
 * 
 */
function makeCodeRender(targetUrl, renderBlocksPackage) {
